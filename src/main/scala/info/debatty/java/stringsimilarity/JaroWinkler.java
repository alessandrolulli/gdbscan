...
import knn.graph.SimilarityInterface;

/**
 *
 * @author tibo
 */
public class JaroWinkler<TID, TN extends INode<TID, String>> implements NormalizedStringSimilarity, NormalizedStringDistance, SimilarityInterface<String>, IMetric<TID, String, TN>
{
