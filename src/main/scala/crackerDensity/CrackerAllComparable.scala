...
//                val edges = begin.flatMap(t => t._2.neigh.flatMap(u => Array((t._1, u._1), (u._1, t._1))))
//                val b = edges
////                .join(treeRDDPropagation.map(t => (t._1, t._2.core))).filter(t => t._2._2 < 1).map(t => (t._1, t._2._1))
//                .join(treeRDDPropagation.map(t => (t._1, t._2.min.get))).map(t => (t._2._1, t._2._2))
//                .join(treeRDDPropagation.map(t => (t._1, t._2.min.get))).map(t => (t._2._1, t._2._2)).filter(t => t._1 != t._2).groupByKey()
//                .map(t => t._1+"\t"+t._2.toSet.mkString(" ")+"\n").reduce((a,b)=>a+b)
////                .map(t => (t._1, (t._2+t._1))
//                util.io.printStat(b, "possible relabelling")
			}
